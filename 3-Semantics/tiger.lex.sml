...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; initMode := false; continue ()))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm;
      (cNested := !cNested+1; continue()))
...
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBuilder := !stringBuilder^"\\^c"; continue()))
fun yyAction57 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringBuilder := !stringBuilder ^ asciiCode(yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction59(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ99(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ22(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            ...
            if inp = #"\\"
              ...
              then if inp = #"!"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction51(strm, yyNO_MATCH)
                          else yyQ6(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                    else if inp = #" "
